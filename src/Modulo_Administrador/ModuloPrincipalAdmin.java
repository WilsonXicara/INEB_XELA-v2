...
import Modulo_Estudiante.ExportarListadoEstudiantes;
...
import Modulo_Prestamos.AnularTodosLosPrestamos;
import Modulo_Prestamos.CrearPaqueteLibro;
import Modulo_Prestamos.CrearPrestamoDePaquete;
import Modulo_Prestamos.VerListadoPrestamos;
...
public class ModuloPrincipalAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        exportar_listado_estudiantes = new javax.swing.JMenuItem();
        ...
        submenu_ver_prestamos = new javax.swing.JMenu();
        item_ver_prestamos = new javax.swing.JMenuItem();
        item_anular_todos_los_prestamos = new javax.swing.JMenuItem();
        ...
        cambiar_contrasenia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/editar(18x18).png"))); // NOI18N
        ...
        cerrar_sesion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/regresar(50x50).png"))); // NOI18N
        ...
        item_nuevo_paquete_libro.setText("Paquete de Libros");
        ...
        item_nuevo_prestamo_paquete.setText("Prestamos de Libros");
        ...
        exportar_listado_estudiantes.setText("Listado de Estudiantes");
        exportar_listado_estudiantes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                exportar_listado_estudiantesActionPerformed(evt);
            }
        });
        menu_ver.add(exportar_listado_estudiantes);
        ...
        menu_ver.add(jSeparator5);

        submenu_ver_prestamos.setText("Préstamo de LIbros");

        item_ver_prestamos.setText("Ver Préstamos");
        item_ver_prestamos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                item_ver_prestamosActionPerformed(evt);
            }
        });
        submenu_ver_prestamos.add(item_ver_prestamos);

        item_anular_todos_los_prestamos.setText("Anular todos los Préstamos");
        item_anular_todos_los_prestamos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                item_anular_todos_los_prestamosActionPerformed(evt);
            }
        });
        submenu_ver_prestamos.add(item_anular_todos_los_prestamos);

        menu_ver.add(submenu_ver_prestamos);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(cambiar_contrasenia)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void item_nuevo_paquete_libroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item_nuevo_paquete_libroActionPerformed
        this.setEnabled(false);
        new CrearPaqueteLibro(conexion, this).setVisible(true);
    ...
    private void item_nuevo_prestamo_paqueteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item_nuevo_prestamo_paqueteActionPerformed
        this.setEnabled(false);
        CrearPrestamoDePaquete nuevoPrestamo = new CrearPrestamoDePaquete(conexion, this);
        nuevoPrestamo.setVisible(nuevoPrestamo.getHacerVisible());
    ...
    private void exportar_listado_estudiantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportar_listado_estudiantesActionPerformed
        ExportarListadoEstudiantes nuevo = new ExportarListadoEstudiantes(this, conexion);
        nuevo.setVisible(nuevo.getHacerVisible());
    }//GEN-LAST:event_exportar_listado_estudiantesActionPerformed

    private void item_ver_prestamosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item_ver_prestamosActionPerformed
        VerListadoPrestamos verPrestamos = new VerListadoPrestamos(conexion, ventanaPadre);
        verPrestamos.setVisible(verPrestamos.getHacerVisible());
    }//GEN-LAST:event_item_ver_prestamosActionPerformed

    private void item_anular_todos_los_prestamosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_item_anular_todos_los_prestamosActionPerformed
        AnularTodosLosPrestamos anularTodos = new AnularTodosLosPrestamos(this, conexion);
        anularTodos.setVisible(anularTodos.getHacerVisible());
    }//GEN-LAST:event_item_anular_todos_los_prestamosActionPerformed
    ...
    private javax.swing.JMenuItem exportar_listado_estudiantes;
    private javax.swing.JMenuItem item_anular_todos_los_prestamos;
    ...
    private javax.swing.JMenuItem item_ver_prestamos;
    ...
    private javax.swing.JMenu submenu_ver_prestamos;
